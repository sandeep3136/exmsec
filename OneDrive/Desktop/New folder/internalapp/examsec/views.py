...
def details(request):
    ...
    return render(request, "examsec/details.html", {'form':form})
...
def bill(request, id):
    ...
    if(request.method == 'POST'):
        if form.is_valid():
            ...
            obs=myFilter.qs
            return render(request, "examsec/rem.html", {'obs': obs, 'myFilter':myFilter})


    return render(request, "examsec/bill.html", {'form': form})
...
def consReport(request):
    ...
    return render(request, 'examsec/report.html', {'obs':obs, 'myFilter':myFilter, 'idlist':idlist})
...
def index(request):
    return render(request, "examsec/examsection.html")
...
def genRL(request, id):
    ...
    pdf = render_to_pdf("examsec/relieving.html", data)
...
def genbill(request, id):
    ...
    pdf = render_to_pdf("examsec/genbill.html", data)
    return HttpResponse(pdf, content_type='application/pdf')
    # if pdf:
